    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/60 dark:bg-black/75 backdrop-blur-md transition-all animate-fadeIn">
      ...
      <div className="relative w-full max-w-md overflow-hidden rounded-3xl border border-zinc-200 dark:border-white/20 bg-white/95 dark:bg-[#141418]/95 p-6 text-zinc-900 dark:text-white shadow-2xl sm:p-8 z-10 backdrop-blur-xl transition-colors duration-300">
        ...
        <button
          type="button"
          onClick={onClose}
          className="absolute right-5 top-5 grid h-8 w-8 place-items-center rounded-full bg-zinc-100 dark:bg-white/10 text-zinc-600 dark:text-white/80 transition hover:bg-zinc-200 dark:hover:bg-white/20 hover:text-zinc-900 dark:hover:text-white cursor-pointer focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-orange-500 focus-visible:ring-offset-1"
        >
          <X className="h-4 w-4" />
        </button>
        ...
        <div className="mt-5 flex rounded-xl bg-zinc-100 dark:bg-white/10 p-1 border border-zinc-200 dark:border-white/10">
          <button
            ...
            className={`flex-1 flex items-center justify-center gap-1.5 py-2 text-xs font-semibold rounded-lg transition cursor-pointer focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-orange-500 focus-visible:ring-offset-1 ${
              activeTab === "login"
        ...
        <form onSubmit={handleAuthSubmit} className="mt-5 space-y-3.5">
          ...
          <button
            type="submit"
            disabled={loading}
            className="w-full rounded-xl py-2.5 text-xs font-bold tracking-wide uppercase bg-gradient-to-r from-orange-500 via-amber-500 to-orange-600 text-white hover:brightness-110 active:scale-[0.99] transition duration-200 shadow-md cursor-pointer disabled:opacity-50 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-orange-500 focus-visible:ring-offset-1"
          >
          ...
          <div className="flex justify-center gap-3">
            {socialProviders.map((provider) => (
              <button
                ...
                className="grid h-10 w-10 place-items-center rounded-xl bg-zinc-100 dark:bg-white/10 border border-zinc-200 dark:border-white/15 hover:bg-zinc-200 dark:hover:bg-white/20 transition transform hover:scale-110 cursor-pointer shadow-2xs disabled:opacity-50 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-orange-500 focus-visible:ring-offset-1"
              >
                <img
                  src={provider.icon}
                  alt={provider.name}
        ...
        >
          ...
          <div className="flex gap-2">
            ...
            <button
              type="submit"
              className="rounded-xl px-3.5 py-2 text-xs font-semibold bg-orange-500 text-white hover:bg-orange-600 transition cursor-pointer shadow-sm focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-orange-500 focus-visible:ring-offset-1"
            >
              Save
            </button>
          </div>
        ...
        <div className="mt-4 border-t border-zinc-200 dark:border-white/10 pt-3 text-center">
          <button
            type="button"
            onClick={onClose}
            className="text-xs font-medium text-zinc-500 dark:text-white/60 hover:text-zinc-900 dark:hover:text-white transition cursor-pointer focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-orange-500 focus-visible:ring-offset-1 rounded-md"
          >
