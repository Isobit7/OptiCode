...
// Shared style to cancel the global color/transition override
    ...
    >
      ...
      <main style={{
        ...
        <div style={{
          ...
          {[
            { icon: <Code style={{ width: 12, height: 12, color: "#f97316", flexShrink: 0 }} />, text: "6 AI Actions · Explain, Humanize, Prettify, Shorten, SEO, Alternatives" },
